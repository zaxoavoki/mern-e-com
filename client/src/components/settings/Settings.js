...
export default function Settings() {
  ...
  const links = [
    { url, title: "Profile information" },
    { url: `${url}/security`, title: "Security" },
    { url: `${url}/address`, title: "Address" },
    { url: `${url}/saved`, title: "Saved products" },
    { url: `${url}/bought`, title: "Bought products" },
  ];
